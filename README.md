...
02. 支持图片消息防撤回，支持查看高清原图

03. 支持文件识别、URL识别、卡片回复消息识别等

04. 支持富文本消息防撤回

05. 支持个人消息防撤回，以及群主或管理员消息防撤回

06. 支持自己发送的消息防撤回

07. 文字消息或富文本消息，允许重新编辑或查看
...
13. 🆕支持消息永不已读（仅支持钉钉7.0.0及以上版本，必须通过“钉钉多开”快捷方式启动钉钉，才可以通过聊天窗口右键临时关闭永不已读功能）

14. 🆕支持屏蔽钉钉升级（试验性功能）

15. 🆕支持右键菜单强制转发消息（有些消息可以转发，有些依然不行，必须通过“钉钉多开”快捷方式启动钉钉）
...
| 7.5.13 | 7.5.13-Release.33110801 [【钉钉安装包历史版本下载】](https://www.wuleba.com/?p=1557) |
...
![Screenshot](https://cdn.jsdelivr.net/gh/flydoos/DingTalkRevokeMsgPatcher/Images/Screenshot-6.0.0.png)
