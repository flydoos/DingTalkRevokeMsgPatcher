...
# 👀钉钉消息防撤回补丁（钉钉消息防撤回插件）
钉钉消息防撤回补丁PC版（原名：钉钉电脑版防撤回插件，也叫：钉钉防撤回补丁、钉钉消息防撤回补丁）由“牛A与牛C之间”开发制作，本程序适用于 Windows 下 PC 版钉钉的消息防撤回，也支持钉钉多开、支持钉钉消息永不已读、支持钉钉去除水印（去水印），支持钉钉6.x或以上版本（不支持5.x旧版本），**目前支持最新版钉钉**。
...
9. 双击安装补丁，增加小火箭进度条特效，解决以往界面无响应问题
...
14. 支持自动设置开机启动，以及支持桌面快捷方式自动更新（如果发生变化自动更新）

15. 新增自动以管理员身份运行本程序

16. 🆕支持消息永不已读（仅支持钉钉7.0.0及以上版本，2024年5月23日开始，不再支持聊天窗口右键临时关闭永不已读功能，如需临时关闭，请重装安装补丁且不要勾选消息永不已读）

17. 🆕新增钉钉去除水印功能（不要关闭补丁程序，否则失效）

18. 由于之前的名字不利于搜索，故软件更名为“钉钉消息防撤回补丁PC版”（原名：钉钉电脑版防撤回插件）

## ~~🌅高级功能~~

**~~以下功能必须通过“钉钉多开.lnk”桌面快捷方式启动钉钉才可以使用：~~**

~~1. 🔥支持屏蔽启动钉钉后的安全风险提醒（试验性功能，对于钉钉7.6.0之后的版本无效）~~
...
| 7.0.30 | 7.0.30-Release.5259107、7.0.30-Release.6019102、7.0.30-Release.6019103 |
| 7.0.31 | 7.0.31-Release.6149102 |
| 7.0.40 | 7.0.40-Release.6289101、7.0.40-Release.6289103、7.0.40-Release.7049102 |
| 7.0.41 | 7.0.41-Release.7179101 |
| 7.0.50 | 7.0.50-Release.8089104、7.0.50-Release.8149101、7.0.50-Release.828910、7.0.50-Release.9059105 |
| 7.0.52 | 7.0.52-Release.9049101 |
| 7.0.55 | 7.0.55-Release.8159101 |
| 7.1.0 | 7.1.0-Release.9159115、7.1.0-Release.10099103 |
| 7.1.10 | 7.1.10-Release.11139102、7.1.10-Release.11169101、7.1.10-Release.11229101、7.1.10-Release.12089105 |
| 7.5.0 | 7.5.0-Release.13039104、7.5.0-Release.13049105、7.5.0-Release.13119104 |
| 7.5.5 | 7.5.5-Release.2049106、7.5.5-Release.2209102 |
| 7.5.10 | 7.5.10-Release.3059121 |
...
| 7.5.30 | 7.5.30-Release.5179102 |
| 7.5.32 | 7.5.32-Release.52910801 |
...
| 7.6.10 | 7.6.10-Release.82010807 |
| 7.6.15 | 7.6.15-Release.91110808、7.6.15-Release.92010808 |
| 7.6.16 | 7.6.16-Release.101710801、7.6.16-Release.102210801 |
| 7.6.25 | 7.6.25-Release.110510808 |
| 7.6.35 | 7.6.35-Release.121110809、7.6.35-Release.122410809、7.6.35-Release.122910807、7.6.35-Release.250115001 |
| 7.6.45 | 7.6.45-Release.250207009、7.6.45-Release.250211009、7.6.45-Release.250212003、7.6.45-Release.250241020 |
| 7.6.55 | 7.6.55-Release.250326009、7.6.55-Release.250402005 |
| 7.6.60 | 7.6.60-Release.250427007、7.6.60-Release.250429003 |
| 7.7.0 | 7.7.0-Release.250522002 |
| 7.8.0 | 7.8.0-Release.250613002 |
| 7.8.5 | 7.8.5-Release.250703007、7.8.5-Release.250710001 |
| 7.8.10 | 7.8.10-Release.250728001 |
| 8.0.0 | 8.0.0-Release.250822005、8.0.10-Release.250911008、8.0.10-Release.250917002 |
| 8.0.2 | 8.0.2-Release.250828011 |
| 8.1.0 | 8.1.0-Release.251016007、8.1.0-Release.251017001、8.1.0-Release.251020004、8.1.0-Release.251021006 |
| 8.1.1 | 8.1.1-Release.251030001 |
| 8.1.5 | 8.1.5-Release.251107001 |
| 8.1.10 | 8.1.10-Release.251201001、8.1.10-Release.251202013 |
| 8.2.0 | 8.2.0-Release.251223004 |
| 8.2.4 | 8.2.4-Release.260104001 |
| 8.2.5 | 8.2.5-Release.260112002 |
| 8.2.10 | 8.2.10-Release.260130007、8.2.10-Release.260203007 |
| 8.2.15 | 8.2.15-Release.260223001、8.2.15-Release.260225001 |
| 8.3.0 | 8.3.0-Release.260316010、8.3.0-Release.260318002、8.3.0-Release.260322001 |
| 8.3.5 | 8.3.5-Release.260328004、8.3.5-Release.260402004 |
| 8.3.10 | 8.3.10-Release.260413002 |
| 8.3.15 | 8.3.15-Release.260424004、**补丁7.0.0版本开始，理论上支持钉钉8.x所有版本** [【钉钉安装包历史版本下载】](https://www.wuleba.com/?p=1557) |
...
![Screenshot](https://cdn.jsdelivr.net/gh/flydoos/DingTalkRevokeMsgPatcher/Images/Screenshot-7.0.0.png)
...
5. 点击安装补丁。界面可能会出现一段时间的无响应，请耐心等待。**由于修改了钉钉的文件，杀毒软件可能会弹出警告，请放行且添加程序目录到信任白名单。**
...
2、安装补丁提示“异常或失败”，实际上却可以消息防撤回，这个可能是因为被你的杀软拦截了，添加信任，然后点击“备份还原”，再次重新“安装补丁”即可

3、**打开钉钉的聊天窗口是空白的？** 这个是因为打补丁的时候，需要生成新文件，但是被杀软或者是你自己不小心终止了任务，导致文件只是生成了一半，文件损坏导致打开空白，解决方法：补丁上面双击“还原备份”，然后重新打一次补丁即可（如果不行，那就重装钉钉，再打一次补丁）

4、消息永不已读功能，**不建议大家往已经存在的消息上追加表情回复**，因为钉钉无法识别这种表情消息，导致你回复了却依然显示消息未读，从而会暴露自己，建议大家自己重新发送消息，这样才会把最近的几条消息也标记成已读
